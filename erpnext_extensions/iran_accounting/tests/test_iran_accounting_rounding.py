...
class TestIranAccountingRounding(unittest.TestCase):
	...
	def test_irr_round_sle_value_fields(self):
		sle = {"company": "Test IRR Company", "stock_value": 1000.68, "stock_value_difference": -0.68}
		with mock.patch(
			"erpnext_extensions.iran_accounting.rounding.get_company_currency", return_value="IRR"
		):
		...
		self.assertEqual(sle.get("valuation_rate", sle.get("valuation_rate")), sle.get("valuation_rate"))
