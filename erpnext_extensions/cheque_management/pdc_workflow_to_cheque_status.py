...
CHEQUE_STATUS_DEBT_PURCHASE_IN_COLLECTION: Final = "Debt Purchase In Collection"
CHEQUE_STATUS_DEBT_PURCHASE_SETTLED: Final = "Debt Purchase Settled"
...
RECEIVABLE_WORKFLOW_TO_CHEQUE_STATUS: Final[dict[str, str]] = {
	...
	WORKFLOW_ASSIGNED_DEBT_PURCHASE: CHEQUE_STATUS_DEBT_PURCHASE_IN_COLLECTION,
	WORKFLOW_DEBT_PURCHASE_SETTLED: CHEQUE_STATUS_DEBT_PURCHASE_SETTLED,
}
