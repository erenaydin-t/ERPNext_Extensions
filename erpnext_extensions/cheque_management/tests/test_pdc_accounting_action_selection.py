...
# Expected ``get_pdc_accounting_decision`` (``None`` = undefined policy on that edge).
_RECEIVABLE_DECISION_BY_EDGE: Final[dict[tuple[str, str], str | None]] = {
	...
	(WORKFLOW_DRAFT, WORKFLOW_CANCELLED): None,
	...
	(WORKFLOW_RETURNED, WORKFLOW_CANCELLED): None,
