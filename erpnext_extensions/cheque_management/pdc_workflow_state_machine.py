...
RECEIVABLE_WORKFLOW_TRANSITIONS: Final[dict[str, frozenset[str]]] = {
	WORKFLOW_DRAFT: frozenset({WORKFLOW_REGISTERED, WORKFLOW_CANCELLED}),
	...
	WORKFLOW_RETURNED: frozenset({WORKFLOW_REPLACED, WORKFLOW_CANCELLED}),
...
PAYABLE_WORKFLOW_TRANSITIONS: Final[dict[str, frozenset[str]]] = {
	WORKFLOW_DRAFT: frozenset({WORKFLOW_REGISTERED, WORKFLOW_CANCELLED}),
	WORKFLOW_REGISTERED: frozenset({WORKFLOW_ISSUED, WORKFLOW_CANCELLED}),
	WORKFLOW_ISSUED: frozenset(
		{WORKFLOW_CLEARED, WORKFLOW_RETURNED, WORKFLOW_REPLACED, WORKFLOW_CANCELLED}
	),
	WORKFLOW_RETURNED: frozenset({WORKFLOW_REPLACED, WORKFLOW_CANCELLED}),
}
