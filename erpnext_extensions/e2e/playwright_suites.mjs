...
export const SUITE_REGISTRY = [
	...
	{
		script: "cheque_management/e2e/playwright_cheque_opening_import_delete_pdc.mjs",
		tags: ["ISOLATED", "SERIAL", "IMPORT", "ACCOUNTING"],
	},
	{
		script: "cheque_management/e2e/playwright_delete_imported_pdc_button_proof.mjs",
		tags: ["FAST", "ISOLATED", "IMPORT"],
	},
	{
		script: "cheque_management/e2e/playwright_delete_imported_pdc_dialog_scenarios.mjs",
		tags: ["FAST", "ISOLATED", "IMPORT"],
	},
	{
	...
	{
		script: "facility_management/e2e/playwright_facility_receipt_je_dimensions.mjs",
		tags: ["ISOLATED", "SERIAL", "ACCOUNTING"],
	},
	{
		script: "facility_management/e2e/playwright_facility_repayment_draft_overrides.mjs",
		tags: ["ISOLATED", "SERIAL", "ACCOUNTING"],
	},
	{
...
export function discoverScripts(root) {
	...
	function walk(dir) {
		for (const ent of fs.readdirSync(dir, { withFileTypes: true })) {
			...
			if (ent.isDirectory() && ent.name !== "node_modules" && ent.name !== "screenshots") {
				walk(p);
			} else if (
				ent.isFile() &&
